    ...
    <>
      ...
      <div
        className={`
          ...
          w-64 h-screen bg-indigo-950
          flex flex-col p-4 gap-4 shrink-0
      ...
      >
        ...
        <div className="mt-auto border-t border-indigo-800 pt-4">
          <p className="text-indigo-400 text-xs px-2 font-medium">
            EduCoach AI
          </p>
          <p className="text-indigo-600 text-xs px-2 mt-1">
